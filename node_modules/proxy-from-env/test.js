...
// Runs the callback with process[REDACTED_FILENAME] temporarily set to env.
function runWithEnv(env, callback) {
  var originalEnv = process[REDACTED_FILENAME];
  process[REDACTED_FILENAME] = env;
  try {
    callback();
  } finally {
    process[REDACTED_FILENAME] = originalEnv;
  }
}
