...
function exec(nodemonOptions, execMap) {
  ...
  options[REDACTED_FILENAME] = {};
  // make sure it's an object (and since we don't have )
  if ({}.toString.apply(nodemonOptions[REDACTED_FILENAME]) === '[object Object]') {
    options[REDACTED_FILENAME] = utils.clone(nodemonOptions[REDACTED_FILENAME]);
  } else if (nodemonOptions[REDACTED_FILENAME] !== undefined) {
